...
| 4   | Migrate your legacy KAAZING Gateway WebSocket or ByteSocket-based client to the WebSocket API-compliant libraries in KAAZING Gateway 5.0. | [Migrate Android and Java Clients to KAAZING Gateway 5.0](https://github.com/kaazing/android.client/blob/develop/migrated/gateway.client.android/doc/p_dev_android_migrate.md) |
