...
public class ByteBufferTest {
    ...
    public void testCompact() throws Exception {
        WrappedByteBuffer readBuffer = WrappedByteBuffer.allocate(512);
        
        byte[] bytes = new byte[521];
        WrappedByteBuffer data = WrappedByteBuffer.wrap(bytes);
        ...
        WrappedByteBuffer data1 = WrappedByteBuffer.wrap(bytes1);
