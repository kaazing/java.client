...
//    String consumerTag;
    ...
    public ChannelEvent(AmqpChannel channel, AmqpFrame frame) {
        this(channel, getKind(frame), frame.getArgs(), null, frame.getBody());
    ...
    public ChannelEvent(AmqpChannel channel, Kind kind, Arg[] args, HashMap<String, Object> headers, ByteBuffer body) {
        super(args);
    ...
    /**
     * @Deprecated -- Please use getAmqpProperties() method instead.
     * 
     * @return Map of properties along with custom headers
     */
