...
import org.kaazing.net.ws.amqp.AmqpArguments.AmqpTableEntry;
...
public final class AmqpBuffer extends WrappedByteBuffer {
    ...
    */
     ...
     * @return ByteBuffer
     */
    private WrappedByteBuffer putUnsignedLong(long v)
    {
        this.putInt(0);
    ...
    private WrappedByteBuffer putMilliseconds(long millis) {
     ...
     public AmqpBuffer putMethodFrame(AmqpMethod method, short channel, Object[] args)
    {
     ...
     private AmqpBuffer putFrame(byte type, short channel, WrappedByteBuffer payload)
    {
    ...
    public AmqpBuffer putBodyFrame(short channel, WrappedByteBuffer payload)
    {
    ...
    WrappedByteBuffer readBuffer = WrappedByteBuffer.allocate(1024);
    
    public void appendBuffer(WrappedByteBuffer in) {
